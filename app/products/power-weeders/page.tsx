...
export default function PowerWeedersPage() {
  const powerWeeders = getProductsByCategory("power weeder")
          ...
          {powerWeeders.map((weeder, index) => (
            <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
              <div className="h-56 relative">
                <Image
                  src={weeder.imageSrc || "/placeholder.svg?height=200&width=200&query=power+weeder"}
                  alt={weeder.name}
                  fill
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <ul className="space-y-1">
                    {weeder.features.slice(0, 4).map((feature, idx) => (
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button asChild className="bg-brand-secondary hover:bg-brand-secondary/90">
                    <Link href={`/products/power-weeders/${weeder.slug}`}>View Details</Link>
                  </Button>
