...
// Water pump products data
const waterPumps = {
  "wd-50": {
    name: "WD50 Water Pump",
    description:
      "Efficient diesel water pump with 4.8HP engine, perfect for irrigation and water transfer applications.",
    features: [
      "Engine Model: 170F Diesel",
      "Max. Power: 4.8HP / 3600RPM",
      "Displacement: 208 cc",
      "Fuel Tank: 3.2 L",
      "Suction x Discharge: 2'' x 2'' (50mm x 50mm)",
      "Max. Head: 28m",
      "Max. Capacity: 30 m³/h",
      "Self-Priming Time: ≤ 60s / 4m",
    ],
    specifications: {
      "Engine Model": "170F Diesel",
      "Max. Power": "4.8HP / 3600RPM",
      ...
      "Max. Capacity": "30 m³/h",
      "Self-Priming Time": "≤ 60s / 4m",
      "Continuous Working Hours": "≥ 4.5h",
      "N.W / G.W": "26 / 28 KGS",
      "Packing Size": "475 x 390 x 415 mm",
    },
    applications: [
      "Irrigation",
    ...
    relatedProducts: [
      {
        name: "WP80",
        description: "Petrol water pump, 7HP, high flow capacity",
        image: "/images/water-pump-wp80.jpg",
        slug: "wp-80",
      },
    ],
    imageSrc: "/images/water-pump-wd50.jpg",
  },
  "wp-80": {
    name: "WP80 Water Pump",
    description:
      "High-capacity petrol water pump with 7HP engine, designed for maximum flow rate and reliable performance.",
    features: [
      "Engine Model: 170F Petrol",
      "Max. Power: 7.0HP / 3600RPM",
      "Displacement: 212 cc",
      "Fuel Tank: 3.6 L",
      "Suction x Discharge: 3'' x 3'' (80mm x 80mm)",
      "Max. Head: 30m",
      "Max. Capacity: 60 m³/h",
      "Self-Priming Time: ≤ 60s / 4m",
    ],
    specifications: {
      ...
      "Max. Capacity": "60 m³/h",
      "Self-Priming Time": "≤ 60s / 4m",
      "Continuous Working Hours": "≥ 2.5h",
      "N.W / G.W": "30 / 32 KGS",
      "Packing Size": "520 x 440 x 470 mm",
    },
    applications: [
      "Large-scale irrigation",
      "Flood control",
      "Construction sites",
      "Swimming pool filling/draining",
    ...
    relatedProducts: [
      {
        name: "WD50",
        description: "Diesel water pump, 4.8HP, self-priming design",
        image: "/images/water-pump-wd50.jpg",
        slug: "wd-50",
      },
    ],
    imageSrc: "/images/water-pump-wp80.jpg",
  },
}

export default function WaterPumpDetailPage({ params }: { params: { slug: string } }) {
  const slug = params.slug
  const product = waterPumps[slug] || waterPumps["wd-50"] // Default to WD50 if slug not found
    ...
    <section className="py-12 md:py-16 lg:py-20">
      <div className="container">
        <div className="flex flex-wrap items-center gap-2 mb-8">
          ...
          <ChevronRight className="h-4 w-4 text-gray-400" />
          <Link href="/products/agricultural/water-pumps" className="text-sm text-gray-500 hover:text-gray-900">
            Water Pumps
          </Link>
          <ChevronRight className="h-4 w-4 text-gray-400" />
        ...
        <Tabs defaultValue="specifications" className="w-full mb-16">
          <TabsList className="grid w-full max-w-md grid-cols-3 mx-auto">
            ...
            <TabsTrigger value="downloads">Maintenance</TabsTrigger>
          </TabsList>
            ...
            {product.relatedProducts.map((relatedProduct, index) => (
              ...
              >
                ...
                <div className="p-4 border-t">
                  ...
                  <Link
                    href={`/products/agricultural/water-pumps/${relatedProduct.slug}`}
