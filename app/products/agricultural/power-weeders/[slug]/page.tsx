...
const powerWeeders = {
  "ht-950d": {
    name: "HT950D Power Weeder",
    description:
      "Versatile 5.5HP power weeder with multi-purpose farming capabilities for various agricultural operations.",
    features: [
      "Engine Model: 175F Diesel",
      "Max. Power: 5.5HP / 3600RPM",
      "Displacement: 246 cc",
      "Fuel Tank: 3.2 L",
      "Starting Method: Manual (Electric Optional)",
      "Gear Shifting: (-1, 0, 1, 2)",
      "Tilling Width: 800 - 950 mm",
    ...
    specifications: {
      ...
      "Tilling Width": "800 - 950 mm",
      "Tilling Depth": "150 - 250 mm",
      "Blade Type": "2 + 1 + 1 Group (24 Nos)",
      Tyre: "4.00-8",
      "N.W / G.W": "125 / 135 KGS",
      "Packing Mode": "Wooden Box",
      "Packing Size": "920 x 550 x 780",
    },
    applications: ["Weeding", "Wasteland Tilling", "Rotary Tilling", "Paddy Fields Tilling", "Ditching"],
    accessories: [
      {
        name: "Deep Hoe Kit",
    ...
    imageSrc: "/images/power-weeder-ht950d.jpg",
  },
  "ht-1050d": {
    ...
    imageSrc: "/images/power-weeder-ht1050d.jpg",
    angleImages: [
      "/images/power-weeder-ht1050d-angle1.jpg",
      "/images/power-weeder-ht1050d-angle2.jpg",
      "/images/power-weeder-ht1050d-angle3.jpg",
      "/images/power-weeder-ht1050d-angle4.jpg",
    ],
  },
  "ht-1350d": {
    name: "HT1350D Power Weeder",
    description:
      "Heavy-duty power weeder with 10HP diesel engine, designed for intensive agricultural operations and maximum productivity.",
    features: [
      "Engine Model: 186F Diesel",
      "Max. Power: 10HP / 3600RPM",
      "Displacement: 418 cc",
      "Fuel Tank: 5.5 L",
      "Starting Method: Electric / Manual",
      "Gear Shifting: (-1, 0, 1, 2)",
      "Tilling Width: 1200 - 1350 mm",
      "Tilling Depth: 150 - 350 mm",
    ],
    specifications: {
      "Engine Model": "186F Diesel",
      "Max. Power": "10HP / 3600RPM",
      ...
      "Tilling Width": "1200 - 1350 mm",
      "Tilling Depth": "150 - 350 mm",
      "Blade Type": "2 + 1 + 1 Group (42 Nos)",
      Tyre: "5.00-12",
      "N.W / G.W": "165 / 175 KGS",
      "Packing Mode": "Wooden Box",
      "Packing Size": "1100 x 620 x 950",
    },
    applications: [
      "Weeding",
      "Wasteland Tilling",
      "Rotary Tilling",
      "Paddy Fields Tilling",
      "Ditching",
      "Irrigating",
    ...
    imageSrc: "/images/power-weeder-ht1350d.jpg",
  },
}

export default function PowerWeederDetailPage({ params }: { params: { slug: string } }) {
  const slug = params.slug
  const product = powerWeeders[slug] || powerWeeders["ht-1050d"] // Default to HT1050D if slug not found
    ...
    <section className="py-12 md:py-16 lg:py-20">
      <div className="container">
        <div className="flex flex-wrap items-center gap-2 mb-8">
          ...
          <ChevronRight className="h-4 w-4 text-gray-400" />
          <Link href="/products/agricultural/power-weeders" className="text-sm text-gray-500 hover:text-gray-900">
            Power Weeders
          </Link>
          <ChevronRight className="h-4 w-4 text-gray-400" />
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div className="bg-white p-8 rounded-lg shadow-md">
            <div className="relative h-[400px] mb-4">
              <Image src={product.imageSrc || "/placeholder.svg"} alt={product.name} fill className="object-contain" />
            </div>
            ...
            {product.relatedProducts.map((relatedProduct, index) => (
              ...
              >
                ...
                <div className="p-4 border-t">
                  ...
                  <Link
                    href={`/products/agricultural/power-weeders/${relatedProduct.slug}`}
